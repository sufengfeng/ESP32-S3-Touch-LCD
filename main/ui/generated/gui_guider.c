...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_welcom_del = true;
    ui->screen_begin_del = true;
    ui->screen_serving_del = true;
    ui->screen_upload_del = true;
    ui->screen_sum_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_welcom(ui);
    lv_scr_load(ui->screen_welcom);
}
