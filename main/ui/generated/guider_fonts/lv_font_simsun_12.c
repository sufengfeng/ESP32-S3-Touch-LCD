...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xf0, 0xf0, 0xf, 0x0, 0xf0, 0x0, 0xf0, 0xf0,
    0xf, 0x0, 0xf0, 0x0, 0xf0, 0xf0, 0xf, 0xff,
    0xff, 0xf0, 0xf0, 0xf0, 0xf, 0xf0, 0xf0, 0xf0,
    ...
    0x0, 0x0, 0x0, 0xf0, 0xf, 0xff, 0xff, 0x0,
    ...
    0xf, 0x0, 0xf, 0x0, 0xff, 0xff, 0xf, 0xff,
    0xff, 0x0, 0x0, 0xf0, 0xf, 0x0, 0xf, 0x0,
    0x0, 0xff, 0xf, 0xff, 0xff, 0x0, 0xf, 0xf0,
    0x0, 0x0, 0x0, 0x0, 0xf0, 0xf0, 0xff, 0xff,
    0xff, 0xf0, 0x0, 0xf0, 0xf, 0xf, 0x0, 0x0,
    0x0, 0xf0, 0xf, 0xf, 0xff, 0x0, 0x0, 0xf0,
    0xf0, 0xff, 0x0, 0x0, 0xff, 0xff, 0x0, 0xf,
    0xff, 0xf0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,

    /* U+786E "确" */
    0x0, 0x0, 0x0, 0xf0, 0x0, 0x0, 0xff, 0xff,
    0xf0, 0xff, 0xff, 0x0, 0x0, 0xf0, 0xf, 0x0,
    0xf0, 0x0, 0xf, 0x0, 0xff, 0xff, 0xff, 0xf0,
    0xf, 0xff, 0xf, 0xf, 0x0, 0xf0, 0xff, 0xf,
    0xf, 0xff, 0xff, 0xf0, 0xf, 0xf, 0xf, 0xf,
    0x0, 0xf0, 0xf, 0xf, 0xf, 0xff, 0xff, 0xf0,
    0xf, 0xff, 0xf, 0xf, 0x0, 0xf0, 0xf, 0xf,
    ...
    0xf, 0x0, 0x0, 0xf0, 0x0, 0xf, 0xff, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    ...
    0xf, 0x0, 0xf, 0x0, 0xf, 0xff, 0xff, 0x0,
    0xf, 0xf, 0xf, 0x0, 0xf, 0x0, 0xf, 0xf0,
    0xf, 0xff, 0xff, 0x0, 0xf, 0x0, 0xf, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2110, .adv_w = 192, .box_w = 12, .box_h = 12, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 2182, .adv_w = 192, .box_w = 12, .box_h = 12, .ofs_x = 0, .ofs_y = -2},
    ...
    {.bitmap_index = 2542, .adv_w = 192, .box_w = 12, .box_h = 12, .ofs_x = 0, .ofs_y = -2},
    ...
    {.bitmap_index = 2764, .adv_w = 192, .box_w = 12, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2818, .adv_w = 192, .box_w = 12, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 2884, .adv_w = 192, .box_w = 12, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2938, .adv_w = 132, .box_w = 9, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2979, .adv_w = 192, .box_w = 12, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3057, .adv_w = 192, .box_w = 12, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3135, .adv_w = 216, .box_w = 14, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3212, .adv_w = 192, .box_w = 12, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3290, .adv_w = 216, .box_w = 14, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3353, .adv_w = 192, .box_w = 12, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3431, .adv_w = 96, .box_w = 6, .box_h = 10, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3461, .adv_w = 144, .box_w = 9, .box_h = 10, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3506, .adv_w = 216, .box_w = 14, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3597, .adv_w = 192, .box_w = 12, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3651, .adv_w = 132, .box_w = 9, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3710, .adv_w = 168, .box_w = 8, .box_h = 12, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 3758, .adv_w = 168, .box_w = 11, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3830, .adv_w = 168, .box_w = 11, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3891, .adv_w = 168, .box_w = 11, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3952, .adv_w = 168, .box_w = 8, .box_h = 12, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 4000, .adv_w = 168, .box_w = 12, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 4066, .adv_w = 120, .box_w = 7, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4105, .adv_w = 120, .box_w = 7, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4144, .adv_w = 168, .box_w = 11, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4205, .adv_w = 168, .box_w = 11, .box_h = 3, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 4222, .adv_w = 216, .box_w = 14, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4285, .adv_w = 240, .box_w = 16, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4389, .adv_w = 216, .box_w = 15, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 4487, .adv_w = 192, .box_w = 12, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4553, .adv_w = 168, .box_w = 11, .box_h = 7, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 4592, .adv_w = 168, .box_w = 11, .box_h = 7, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 4631, .adv_w = 240, .box_w = 16, .box_h = 10, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 4711, .adv_w = 192, .box_w = 12, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4765, .adv_w = 192, .box_w = 12, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4843, .adv_w = 192, .box_w = 13, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 4928, .adv_w = 168, .box_w = 11, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4989, .adv_w = 168, .box_w = 11, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5061, .adv_w = 168, .box_w = 11, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5122, .adv_w = 168, .box_w = 11, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5183, .adv_w = 192, .box_w = 12, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5237, .adv_w = 120, .box_w = 9, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 5296, .adv_w = 168, .box_w = 11, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5368, .adv_w = 168, .box_w = 11, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5440, .adv_w = 216, .box_w = 14, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5503, .adv_w = 192, .box_w = 14, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 5594, .adv_w = 144, .box_w = 9, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5653, .adv_w = 240, .box_w = 15, .box_h = 12, .ofs_x = 0, .ofs_y = -1},
    ...
    {.bitmap_index = 6083, .adv_w = 240, .box_w = 16, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6171, .adv_w = 168, .box_w = 10, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6236, .adv_w = 168, .box_w = 11, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6308, .adv_w = 192, .box_w = 13, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 6393, .adv_w = 240, .box_w = 15, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6461, .adv_w = 144, .box_w = 9, .box_h = 13, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6520, .adv_w = 193, .box_w = 13, .box_h = 9, .ofs_x = 0, .ofs_y = 0}
};
...
static const uint16_t unicode_list_1[] = {
    0x0, 0x393, 0x4bd, 0xcf6, 0x152c, 0x29ca, 0x2a96, 0x3d53,
    0xa15d, 0xa164, 0xa167, 0xa168, 0xa169, 0xa16d, 0xa16f, 0xa171,
    0xa175, 0xa178, 0xa17d, 0xa182, 0xa183, 0xa184, 0xa19a, 0xa19f,
    0xa1a4, 0xa1a7, 0xa1a8, 0xa1a9, 0xa1ad, 0xa1ae, 0xa1af, 0xa1b0,
    0xa1c3, 0xa1c4, 0xa1ca, 0xa1cc, 0xa1cd, 0xa1d0, 0xa1d3, 0xa1d4,
    0xa1d5, 0xa1d7, 0xa1ef, 0xa1f1, 0xa220, 0xa221, 0xa223, 0xa225,
    0xa23c, 0xa243, 0xa246, 0xa24f, 0xa278, 0xa280, 0xa2b7, 0xa347,
    0xa39c, 0xa39d, 0xa39e, 0xa39f, 0xa3a0, 0xa3e3, 0xa3ef, 0xa449,
    0xa460, 0xa6b6, 0xa91e, 0xa9fe
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 20132, .range_length = 43519, .glyph_id_start = 96,
