...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 514, .box_w = 31, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 527, .adv_w = 495, .box_w = 27, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 986, .adv_w = 384, .box_w = 24, .box_h = 4, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1034, .adv_w = 812, .box_w = 43, .box_h = 26, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 1593, .adv_w = 523, .box_w = 25, .box_h = 26, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 1918, .adv_w = 488, .box_w = 27, .box_h = 26, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2269, .adv_w = 318, .box_w = 19, .box_h = 32, .ofs_x = 0, .ofs_y = 0}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x4, 0x2b, 0x39, 0x3a, 0x3b, 0x40
};
...
{
    {
        .range_start = 52, .range_length = 65, .glyph_id_start = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_customer_font_montserratMedium_48 = {
#else
